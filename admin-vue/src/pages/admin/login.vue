    ...
    <div class="grid grid-cols-2 h-screen">
        ...
        <div class="col-span-2 order-2 p-10 md:col-span-1 md:order-1 bg-zinc-700">
            ...
            <div
                ...
                <h2 class="font-bold text-4xl mb-7 text-white">EnglishLearningApp后台管理</h2>
                <p class="text-white">一款由 Spring Boot + Mybaits Plus + Vue 3.2 + 微信小程序开发的在线英语学习App。</p>
                <!-- 指定图片宽度为父级元素的 1/2 -->
                <img src="@/assets/logo.png" class="w-1/2">
            </div>
        </div>
        <div class="col-span-2 order-2 p-10 md:col-span-1 md:order-1 bg-white">
            ...
            <div
                ...
                <!-- 大标题，设置字体粗细、大小、下边距 -->
                <h1 class="font-bold text-4xl mb-5">管理员登录</h1>
                ...
                <el-form class="w-5/6 md:w-2/5" ref="formRef" :model="form">
                    ...
                    <el-form-item>
                        <!-- 密码框组件 -->
                        <el-input size="large" type="password" v-model="form.password" placeholder="请输入用户名"
...
const onSubmit = () => {
    formRef.value.validate((valid) => {
        ...
        //调用登录接口
        login(adminLoginRequest).then((res) => {
            //判断是否成功
